...
| be read over a hundred times more often than is   | | * Home        |
| written? Most of a developer's time is spent      | | * Download    |
| and trying to understand code. Sigvehtml is a     | | * Legal       |
| HTML dialect which focuses on readability and     | | * About Us    |
| the ability to get a quick overview.              | |               |
|                                                   | |               |
| With sigvehtml, there is no longer any need to    | |               |
| wade trough thickets of nested divs and spans     | |               |
| and what-have-you's to get to a real              | |               |
| understanding of what is going on. Throw the      | |               |
| boilerplate soup out of the window, and increase  | |               |
| your productivity hundred-fold by re-writing all  | |               |
| your code to sigvehtml. You wont regret it.       | |               |
|                                                   | |               |
